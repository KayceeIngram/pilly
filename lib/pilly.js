...
*  - File Name & File Type [!OPTIONAL]
*     -> "Preferred default file name and type for each chapter dir. If File name is only provided and no extenstion (ex: .js) then it defaults to .txt"
*/
...
* - chNumber [!REQUIRED]
*    -> "Match # of Book's Chapters.",
* - fileName (with extension (ex: .js)) [!OPTIONAL]
*    -> "Preferred default file name and type for each chapter dir."
*/
